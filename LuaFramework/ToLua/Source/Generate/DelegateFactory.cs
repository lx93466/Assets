...
public static class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(UnityEngine.Events.UnityAction<UIEventParam>), UnityEngine_Events_UnityAction_UIEventParam);
	...
	class UnityEngine_Events_UnityAction_UIEventParam_Event : LuaDelegate
	{
		public UnityEngine_Events_UnityAction_UIEventParam_Event(LuaFunction func) : base(func) { }
		public UnityEngine_Events_UnityAction_UIEventParam_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(UIEventParam param0)
		{
			func.BeginPCall();
		...
		public void CallWithSelf(UIEventParam param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public static Delegate UnityEngine_Events_UnityAction_UIEventParam(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			UnityEngine.Events.UnityAction<UIEventParam> fn = delegate(UIEventParam param0) { };
			return fn;
		}

		if(!flag)
		{
			UnityEngine_Events_UnityAction_UIEventParam_Event target = new UnityEngine_Events_UnityAction_UIEventParam_Event(func);
			UnityEngine.Events.UnityAction<UIEventParam> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			UnityEngine_Events_UnityAction_UIEventParam_Event target = new UnityEngine_Events_UnityAction_UIEventParam_Event(func, self);
			UnityEngine.Events.UnityAction<UIEventParam> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}
