...
public class LuaFramework_UtilWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("AddUIEventListener", AddUIEventListener);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int AddUIEventListener(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.CheckUnityObject(L, 1, typeof(UnityEngine.GameObject));
			UnityEngine.Events.UnityAction<UIEventParam> arg1 = null;
			LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

			if (funcType2 != LuaTypes.LUA_TFUNCTION)
			{
				 arg1 = (UnityEngine.Events.UnityAction<UIEventParam>)ToLua.CheckObject(L, 2, typeof(UnityEngine.Events.UnityAction<UIEventParam>));
			}
			else
			{
				LuaFunction func = ToLua.ToLuaFunction(L, 2);
				arg1 = DelegateFactory.CreateDelegate(typeof(UnityEngine.Events.UnityAction<UIEventParam>), func) as UnityEngine.Events.UnityAction<UIEventParam>;
			}

			LuaFramework.Util.AddUIEventListener(arg0, arg1);
			return 0;
		}
		catch(Exception e)
		{
	...
	static int AddLuaComponent(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Transform), typeof(LuaInterface.LuaTable)))
			{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: LuaFramework.Util.AddLuaComponent");
			}
		}
		catch(Exception e)
		{
