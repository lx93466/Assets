...
function PromptCtrl.Create()
	logWarn("PromptCtrl.Create--->>");
...
function PromptCtrl.OnCreate(obj)
   ...
   tab = Util.AddLuaComponent(transform, PromptPanel);
...
function PromptCtrl.InitPanel(objs)
	local count = 100; 
	local par = gameObject.transform:FindChild('ScrollView/Grid');
    logWarn('&&&****************************************'..par)
 	for i = 1, count do
