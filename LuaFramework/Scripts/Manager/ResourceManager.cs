...
namespace LuaFramework {
	...
	public class ResourceManager : MonoBehaviour {
		...
		//加载请求缓存<key, value> key:assetbundle名称   value：加载资源名称。 由于是异步加载，可能存在一个资源没加载完，又请求另外资源加载请求，所有缓存加载请求
		...
		/// <param name="assetNames">要加载的位于assetbundle的资源</param>
		/// <param name="action">加载后回调</param>
		/// <param name="func">Lua函数回调</param>
		...
		/// <summary>
		/// 加载资源时，先从缓存加载，如果缓存没有，则先加载本地assetbundle
		/// </summary>
